...
const translations: Translations = {
  ...
  coupons: { en: "Coupons", vi: "Mã giảm giá" },
  ...
  categoryManagement: { en: "Category Management", vi: "Quản lý danh mục" },
  categoryDescription: { en: "Manage product categories, slugs, and icons.", vi: "Quản lý loại sản phẩm, đường dẫn và biểu tượng." },
  addCategory: { en: "Add Category", vi: "Thêm danh mục" },
  editCategory: { en: "Edit Category", vi: "Sửa danh mục" },
  couponManagement: { en: "Coupon Management", vi: "Quản lý mã giảm giá" },
  couponDescription: { en: "Create and manage promotional discount codes.", vi: "Tạo và quản lý các mã khuyến mãi, giảm giá." },
  addCoupon: { en: "Add Coupon", vi: "Thêm mã giảm giá" },
  editCoupon: { en: "Edit Coupon", vi: "Sửa mã giảm giá" },
  couponCode: { en: "Coupon Code", vi: "Mã giảm giá" },
  discountValue: { en: "Discount Value", vi: "Giá trị giảm" },
  usageLimit: { en: "Usage Limit", vi: "Lượt sử dụng" },
  expiryDate: { en: "Expiry Date", vi: "Hạn sử dụng" },
